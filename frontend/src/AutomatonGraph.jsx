  ...
  useEffect(() => {
      ...
      graphData.nodes.map((node) => {
        ...
        return {
          ...
          font: {
            ...
            color: fontColor,
            bold: { size: 15, face: "system-ui, sans-serif", color: fontColor, mod: "bold" },
          },
    ...
    const edges = new DataSet(
      graphData.edges.map((edge, i) => ({
        ...
        hoverWidth: 3,
        selectionWidth: 3,
        smooth: edge.source === edge.target
        ...
        font: {
          ...
          strokeColor: "#ffffff",
          align: "middle",
          bold: { size: 13, face: "system-ui, sans-serif", color: "#0f172a", mod: "bold" },
        },
    ...
    networkRef.current.on("afterDrawing", (ctx) => {
      ...
      graphData.nodes.filter((n) => n.isAccept).forEach((n) => {
      ...
      graphData.nodes.filter((n) => n.isStart).forEach((n) => {
        const pos = networkRef.current.getPosition(n.id);
    ...
    >
      ...
      >
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 14, alignItems: "center" }}>
          ...
          <span style={{ fontSize: 11, color: "#94a3b8", borderLeft: "1px solid #e2e8f0", paddingLeft: 10 }}>
            drag · scroll to zoom
          </span>
        </div>
      </div>
